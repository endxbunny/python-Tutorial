...
logolabel = Label(root, image=logoImage, bg='white')  # Incert the cal logo
logolabel.grid(row=0, column=0)

entryField = Entry(root, font=('arial', 25, 'bold'), bg='black', fg='white', bd=10, relief=GROOVE,
                   width=30)  # This is Entry Field Block
entryField.grid(row=0, column=0, columnspan=8)

micImage = PhotoImage(file='78731.png')
micbutton = Button(root, image=micImage, bg='white')  # Incert the mic logo
...
for i in button_text_list:
    ...
    button = Button(root, width=5, height=2, bd=2, relief=GROOVE, text=i, bg='skyblue', fg='white',
                    font=('arial', 18, 'bold'), activebackground='skyblue', command=lambda button=i: click(button))
